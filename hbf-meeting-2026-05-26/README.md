...
the young researcher (Cameron Berg, [AE Studio](https://ae.studio)) and author of [LLMs Report Subjective Experience under Self-Referential Processing](https://glia.ca/2026/hbf/#ae-studio). See also the _emotion_ [paper](https://www.anthropic.com/research/emotion-concepts-function) and [video](https://youtu.be/D4XTefP3Lsc) from Anthropic, the metaphors of [_dreaming_](https://claude.com/blog/new-in-claude-managed-agents) - extends [_memory_](https://claude.com/blog/claude-managed-agents-memory) by reviewing past sessions to find patterns and help agents self-improve, and this one on converting LLM activations into natural language: https://transformer-circuits.pub/2026/nla.
