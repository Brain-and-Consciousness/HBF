...
|----------|-----------|---------|--------|-----------|
| **2024:**    |     |     |      |        |
| 2023-04-30 | Halvor Næss     | _Brain and Creativity_ (Creativity provides unpredictable knowledge and is based on selectionist processes restricted by the second law of thermodynamics) | [Link] | [Here](https://no.wikipedia.org/wiki/Halvor_N%C3%A6ss_(nevrolog)) and [here](https://scholar.google.no/citations?user=IxinAX4AAAAJ&hl=no)|
